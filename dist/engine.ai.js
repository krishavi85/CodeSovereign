  ...
  function consumers() {
    ...
    var list = [
      ...
      { id: 'requirements', label: 'Requirements intelligence (Engine.Requirements)',
        wired: !!(E.Requirements && E.Requirements.__aiAssist),
        how: 'rule-based domain packs; AI archetype detection not wired' },
      { id: 'universal', label: 'Prompt normalizer / classifier (Engine.Universal)',
        wired: !!(E.Universal && E.Universal.__aiAssist),
        how: 'keyword rules; an LLM normalize pass is not wired' },
